...
*/
package trace // import "github.com/laincloud/net/trace"
...
import (
	...
	"github.com/laincloud/net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		...
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"github.com/laincloud/net/trace in your binary, trying to maintain separate state. This may " +
...
var contextKey = contextKeyT("github.com/laincloud/net/trace.Trace")
